...
st.title("⚔️ Radar Craft — Black Market Scanner")

with st.sidebar:
    st.image("https://assets.albiononline.com/assets/images/shop/starter-packs/vanity/knight-adventurer-male.webp", width=150)
